...
> I don’t aim for perfection — I aim for **progress, consistency, and learning in public**.
...
- 🧠 **Used Car Sales Prediction (ML Research Internship – BIT Sindri)**  
  End-to-end ML pipeline: preprocessing, feature engineering, evaluation

- 🔗 **Smart Student Hub (SIH 2025)**  
  Blockchain-based academic record verification system

- 🌐 **Backend APIs & Full-Stack Apps**  
  Node.js, Express, authentication, RESTful design
